    ...
    <body class="identification">
        <form method="post" action="auth.php" class="identification">
            ...
            <div class="contenuform">
                <p class="infoform">Pour pouvoir utiliser Opencomp, vous devez supprimer le répertoire /install de votre serveur.<br /><br />
                Après avoir supprimé le répertoire /install, cliquez sur "Actualiser".</p>
            </div>
            <p class="bottomform"><input type="button" value="Actualiser" ONCLICK="location.reload()"></p>
        </form>
    </body>
</html>
<?
