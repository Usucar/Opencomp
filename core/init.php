...
//Connexion sql
@mysql_connect($dbhote, $dbuser, $dbpass) or die('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
		<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr" >
			...
			<body class="identification">
				...
				<form method="post" action="auth.php" class="identification">
					...
					<p class="icon_error">Oups ... erreur critique</p>
					</div>

					<div class="contenuform">
						<p class="infoform">
							Il est impossible de se connecter à la base de données.<br /><br />

							Vous pouvez tenter de rafraichir la page.<br /><br />

							Si le problème persiste, vous avez la possibilité de contacter l\'administrateur de l\'application Gnote.
						</p>
					</div>
					<p class="bottomform">
